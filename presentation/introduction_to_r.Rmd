...
- Quick test: Can you write a dplyr chain to give me all the addresses, suburbs and prices for those properties that were townhouses (type is 't') and sold for more than 1.2 million sorted by descending order of price?
